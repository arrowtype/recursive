...
```bash
python build.py --statfiles --version 1.057 # (replace version number)
...
```bash
python build.py --varfiles --version 1.057 # (replace version number)
python build.py --variable --version 1.057 # (replace version number)
```
