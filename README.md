...
version=1.082 # (replace version number)
...
```bash
# activate venv, install dependencies, cd mastering
python build.py --all --version 1.082 # (replace version number)
```
...
```bash
# activate venv, install dependencies, cd mastering
python build.py --all --pync --version 1.082 # (replace version number)
```
