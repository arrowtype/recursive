...
# make a dictionary of point locations for point index
# in the point-drawing loop, add each point's coordinates to this dictionary
# after the loop, draw strokes between [0] and [1] of each dictionary item
...
# print(json.dumps(pointsDict, indent=2))  