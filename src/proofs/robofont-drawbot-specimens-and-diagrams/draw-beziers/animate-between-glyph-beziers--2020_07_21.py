...
#     "background": hex2rgb("#f2f2fa"),  # light blue
#     "glyphBox": (*hex2rgb("#000000"), 0.05),  #(0,0,0),
#     "glyphFill": (*hex2rgb("#000000"), 0.15),
...
for frame in range(frames):
    ...
    scale(x=W/1080, y=H/1080, center=(W/2, H/2)) # scale to other dimensions if not 1080x1080
    ...
    for key in metricsYf1.keys():
        # skipping ascender & x-height guides for cap animation
        if key == "x" or key == "a":
            continue
        if key == "x":
