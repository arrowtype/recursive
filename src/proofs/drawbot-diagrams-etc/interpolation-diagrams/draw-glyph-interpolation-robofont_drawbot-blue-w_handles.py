...
for f in AllFonts():
    ...
    if glyphNum == 0:
        ...
        glyphColor = normalRGB(255, 255, 255) # normalRGB(0, 80, 255)
    ...
    for c in g:
        for p in c.bPoints:
            ...
            # help(p)
            # for p in s:
            pointsColor = normalRGB(0, 80, 255) #normalRGB(210, 46, 237)
            ...
            pointsColor = normalRGB(0, 80, 255)
...
saveImage(f"exports/recursive-interpolation-diagram-{glyphName}-{now}.png")